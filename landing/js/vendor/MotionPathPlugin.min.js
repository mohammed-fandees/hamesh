...
!(function (t, e) {
    ...
    if (p || r) {
      for (
        i = y < P || (R && b < M) || (L && m.t < d.t),
          z(a, P, M, d.t) &&
            (P++, i || (y++, L ? ((m.t = (m.t - d.t) / (1 - d.t)), (b = 0)) : R && (b -= M))),
          Math.abs(1 - (n - e)) < 1e-5
            ? (y = P - 1)
            : !m.t && y
              ? y--
  ...
  function measureSegment(t, e, n) {
    ...
    if (T.length && C) {
      if (((t.totalLength = y = T[T.length - 1] || 0), y / (t.minLength = C) < 9999))
  ...
  function arcToSegment(t, e, n, r, a, o, i, s, l) {
    if (t !== s || e !== l) {
      ...
      var R = (o === i ? -1 : 1) * H(M),
        ...
        z = (_ * O - N * A < 0 ? -1 : 1) * Math.acos((_ * A + N * O) / H(B * (A * A + O * O)));
      (isNaN(z) && (z = f), !i && 0 < z ? (z -= c) : i && z < 0 && (z += c), (E %= c), (z %= c));
      var D,
        I = Math.ceil(U(z) / (c / 4)),
        Y = [],
        k = z / I,
      ...
      for (D = 0; D < Y.length; D += 2)
        ((m = Y[D]), (v = Y[D + 1]), (Y[D] = m * j + v * X + S), (Y[D + 1] = m * q + v * $ + C));
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < x; e++)
      if (
        ...
        ((u = w),
          (g = y),
          ('C' !== c && 'S' !== c) || ((u += w - s[s.length - 4]), (g += y - s[s.length - 3])),
          i || (w = y = 0),
    ...
    return ((e = s.length) < 6 ? (v.pop(), (e = 0)) : L(s), (v.totalPoints = P + e), v);
  }
    ...
    for (
      ...
      ((n = v),
        ...
        (v === y && w === x) ||
          ...
          (M = x - w),
          R[a]
            ? P.push(v - (v - n) / 4, w - (w - r) / 4, v, w, v + (y - v) / 4, w + (x - w) / 4)
            : ((h =
              ...
              (f =
                v -
                ((u = v - (v - n) * (s ? h / s : 0)) +
                  ((((g = v + (y - v) * (l ? h / l : 0)) - u) * ((3 * s) / (s + l) + 0.5)) / 4 ||
                    0))),
              (d =
                w -
                ((c = w - (w - r) * (s ? h / s : 0)) +
                  ((((p = w + (x - w) * (l ? h / l : 0)) - c) * ((3 * s) / (s + l) + 0.5)) / 4 ||
                    0))),
              P.push(N(u + f), N(c + d), N(v), N(w), N(g + f), N(p + d)))));
    return (
      v !== y || w !== x || P.length < 4 ? P.push(N(y), N(x), N(y), N(x)) : (P.length -= 2),
      2 === P.length ? P.push(v, w, v, w, v, w) : L && (P.splice(0, 6), (P.length -= 6)),
      (P.closed = L),
      P
    );
  }
  ...
  function S(t) {
    ...
    !(G in t.style) && 'msTransform' in t.style && (j = (G = 'msTransform') + 'Origin');
            ...
            -(a = (function _getCTM(t) {
              ...
              return (
                n ||
                  ...
                  e
                    ? (t.style[G] = e)
                    : t.style.removeProperty(G.replace(/([A-Z])/g, '-$1').toLowerCase())),
                n || E.clone()
              );
            })(t)).e / a.a),
          (i = -a.f / a.d),
    ...
    Q =
      (((n = Matrix2D.prototype).inverse = function inverse() {
        var t = this.a,
          ...
          o = this.f,
          i = t * r - e * n || 1e-10;
        return ca(this, r / i, -e / i, -n / i, t / i, (n * o - r * a) / i, -(t * o - e * a) / i);
      }),
  ...
  function getGlobalMatrix(t, e, n, r) {
    if (!t || !t.parentNode || (c || S(t)).documentElement === t) return new Q();
        ...
        s.left +
          (g
            ...
            : (function _getDocScrollLeft() {
                return v.pageXOffset || c.scrollLeft || w.scrollLeft || y.scrollLeft || 0;
              })()),
        s.top +
          (g
            ? 0
            : (function _getDocScrollTop() {
                return v.pageYOffset || c.scrollTop || w.scrollTop || y.scrollTop || 0;
              })()),
      );
  ...
  function ra(t, e, n, r, a, o, i, s, l) {
    return (
      (e =
        'cubic' === i.type
          ? [e]
          : (!1 !== i.fromCurrent && e.unshift(pa(n, r, s), a ? pa(n, a, l) : 0),
            i.relative && qa(e),
  ...
  var W,
      ...
      return t && t.length
        ? (i &&
            ('self' === i || (r = K(i)[0] || e) === e
              ...
              : (u && !1 !== u[2]
                  ? W.set(e, { transformOrigin: 100 * u[0] + '% ' + 100 * u[1] + '%' })
    ...
    at = function _addDimensionalPropTween(t, e, n, r, a, o) {
      ...
      ((u.u = J(i.get(e, h, o)) || 0), (u.path = r), (u.pp = a), t._props.push(h));
    },
    a = {
      version: '3.15.0',
      name: 'motionPath',
      ...
      init: function init(t, e, n) {
        if (!W) return (console.warn('Please gsap.registerPlugin(MotionPathPlugin)'), !1);
        ...
        if (
          ...
          (cacheRawPathMeasurements((r = c(rt(getRawPath(e.path), t, e))), e.resolution),
            o.push(r),
            at(this, t, e.x || 'x', r, 'x', e.unitX || 'px'),
            at(this, t, e.y || 'y', r, 'y', e.unitY || 'px'));
        else {
          for (a in f) !u && ~et.indexOf(a) ? (u = a) : !g && ~nt.indexOf(a) && (g = a);
          for (a in (u && g
            ? o.push(
                ra(
                  this,
            ...
            : (u = g = 0),
          f))
            a !== u && a !== g && o.push(ra(this, oa([], i, a, 2), t, a, 0, c, e, J(i[0][a])));
        }
      ...
      render: function render(t, e) {
        ...
        if (e.tween._time || !o()) {
          ...
          e.rotate &&
            e.rSet(e.target, e.rProp, n[0].angle * (e.radians ? i : 1) + e.rOffset + e.ru, e, t);
      ...
      arrayToRawPath: function arrayToRawPath(t, e) {
        ...
        return (e.relative && qa(n), ['cubic' === e.type ? n : pointsToSegment(n, e.curviness)]);
      },
    };
  (!(function _getGSAP() {
